...
class ActionClientState(object):
    ...
    Attributes:
        action_client (:obj:`actionlib.simple_action_client.SimpleActionClient`): The
            action client to which the ActionClientState object is linked.
        state (int): The current state value of the action client.
        state_string (str): The name of the current state of the action client.
        state_value_dict (dict): The dictionary containing all the possible state values
            of the action client with the corresponding states.
        state_dict (dict): The dictionary containing all the possible states of the
            action client with the corresponding state values.
    """

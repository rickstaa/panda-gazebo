...
from panda_gazebo.core import GroupPublisher
from panda_gazebo.exceptions import InputMessageInvalidError
from panda_gazebo.extras import ActionClientState
...
class PandaControlServer(object):
    ...
    def _get_combined_action_server_fb_msg(self):
        ...
        Returns
        -------
        panda_gazebo.msg.FollowJointTrajectoryFeedback
        ...
        if controlled_joints:
            ...
            try:
                ...
                rospy.loginfo(
                    ...
                    % (control_type, e.details["controlled_joints"], control_type,)
                )
                return False
    ...
    def _set_joint_positions_cb(self, set_joint_positions_req):
        ...
        Parameters
        ----------
        set_joint_positions_req : panda_gazebo.srv.SetJointPositionsRequest
    ...
    def _set_joint_efforts_cb(self, set_joint_efforts_req):
        ...
        Parameters
        ----------
        set_joint_efforts_req : panda_gazebo.srv.SetJointEffortsRequest
    ...
    def _switch_control_type_cb(self, switch_control_type_req):
        ...
        Parameters
        ----------
        switch_control_type_req : panda_gazebo.srv.SwitchControlTypeRequest
            Service request message to switch the control_type.

        Returns
        -------
        panda_gazebo.srv.SwitchControlTypeResponse
            Service response.
        """
    ...
    def _list_control_type_cb(self, list_control_type_req):
        ...
        Parameters
        ----------
        list_control_type_req : panda_gazebo.srv.ListControlTypeRequest
            Service request message to list the control_type.

        Returns
        -------
        panda_gazebo.srv.ListControlTypeResponse
    ...
    def _get_controlled_joints_cb(self, get_controlled_joints_req):
        ...
        Parameters
        ----------
        get_controlled_joints_req : panda_gazebo.srv.GetControlledJointsRequest

...
#################################################
class PandaPickAndPlaceEnv(PandaTaskEnv, utils.EzPickle):
    """Classed used to create a Panda Pick and Place environment. It inherits from the
    ...
    def __init__(
        ...
        super(PandaPickAndPlaceEnv, self).__init__(
